  ...
  return (
    <S.Wrapper color={color} size={size} hideOnMobile={hideOnMobile}>
      ...
      >
        ...
        />
        <path
          d="M7.592 7.103c-5.11 2.755-4.519 5-4.519 7.5m54.201 11.5v1m-54.222-9v2m54.222 10v5"
          stroke="#fff"
          strokeOpacity=".4"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M13.053 15.103v6m-3.013-3h6.025"
          stroke="#0A0D27"
          strokeWidth="2"
          strokeLinecap="round"
        />
        <ellipse
          rx="1.506"
          ry="1.5"
          transform="translate(44.723 13.66)"
          fill="#0A0D27"
        />
        <ellipse
          rx="1.506"
          ry="1.5"
          transform="translate(49.743 17.603)"
          fill="#0A0D27"
        />
        <ellipse
          rx="1.506"
          ry="1.5"
          transform="translate(44.723 21.603)"
          fill="#0A0D27"
        />
        <ellipse
          rx="1.506"
          ry="1.5"
          transform="translate(39.703 17.603)"
          fill="#0A0D27"
        />
        <path
          className="text"
